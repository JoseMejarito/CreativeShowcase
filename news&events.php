        ...
        <div class="max-w-screen-xl mx-auto px-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg flex flex-col justify-between">
                    <img src="public/event1.jpg" alt="Event 1" class="w-full h-60 object-cover mb-4 rounded-md">
                ...
                <!-- Event Item 2 -->
                <div class="bg-white p-6 rounded-lg shadow-lg flex flex-col justify-between">
                    <img src="public/event2.jpg" alt="Event 2" class="w-full h-60 object-cover mb-4 rounded-md">
                ...
                <!-- Event Item 3 -->
                <div class="bg-white p-6 rounded-lg shadow-lg flex flex-col justify-between">
                    <img src="public/event3.jpg" alt="Event 3" class="w-full h-60 object-cover mb-4 rounded-md">
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg flex flex-col justify-between hidden md:block">
                    <img src="public/event4.jpg" alt="Event 4" class="w-full h-60 object-cover mb-4 rounded-md">
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg flex flex-col justify-between hidden md:block">
                    <img src="public/event5.jpg" alt="Event 5" class="w-full h-60 object-cover mb-4 rounded-md">
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg flex flex-col justify-between hidden md:block">
                    <img src="public/event6.jpg" alt="Event 6" class="w-full h-60 object-cover mb-4 rounded-md">
